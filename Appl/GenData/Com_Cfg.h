...
#define ComConf_ComGroupSignal_myComGroupSignal01                     1u
#define ComConf_ComSignal_RearLeft_Window                             2u
#define ComConf_ComSignal_RearRight_Window                            3u
#define ComConf_ComSignal_sig_FrongtIntorLight_omsg_Transmit2_oCAN00_db11f0a8_Tx 4u
#define ComConf_ComSignal_sig_LampCnt_omsg_MyECU_Lamp_oCAN00_f37e68ea_Tx 5u
#define ComConf_ComSignal_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx 6u
/**\} */
...
#define Com_GetPduOffsetOfTxSigGrpInfo(Index)                         ((Com_PduOffsetOfTxSigGrpInfoType)((((Com_PduOffsetOfTxSigGrpInfoType)(Index)) + 1u)))  /**< Byte offset relative to the PDU the signal group is starting. */
...
#define Com_GetTxBufferEndIdxOfTxSigGrpInfo(Index)                    ((Com_TxBufferEndIdxOfTxSigGrpInfoType)((((Com_TxBufferEndIdxOfTxSigGrpInfoType)(Index)) + 29u)))  /**< the end index of the 0:n relation pointing to Com_TxBuffer */
...
#define Com_GetTxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfo(Index)      ((Com_TxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfoType)((((Com_TxBufferSigGrpInTxIPDUEndIdxOfTxSigGrpInfoType)(Index)) + 22u)))  /**< the end index of the 1:n relation pointing to Com_TxBuffer */
...
#define Com_GetTxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfo(Index)    ((Com_TxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfoType)((((Com_TxBufferSigGrpInTxIPDUStartIdxOfTxSigGrpInfoType)(Index)) + 18u)))  /**< the start index of the 1:n relation pointing to Com_TxBuffer */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_TxBufferType, COM_VAR_NOINIT) Com_TxBuffer[29];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
